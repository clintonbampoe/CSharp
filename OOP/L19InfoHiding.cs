class L19InfoHiding {
    public static void Run() {
        ...
        // ARROW HEAD
        DisplayArrowHead();
        newArrow.SetHead(PickArrowHead()); 

        // ARROW FLETCHING
        DisplayArrowFletching();
        newArrow.SetFletching(PickArrowFletching());

        // SHAFT LENGTH
        DisplayArrowShaft();
        newArrow.SetShaft(PickArrowShaft());

        // GET COST
        float arrowCost = GetCost(newArrow.GetHead(), newArrow.GetFletching(), newArrow.GetShaft());
    ...
    class Arrow {
        ...
        // Setter Methods
        public void SetHead(ArrowHead value) {
            _head = value;
        }
        public void SetFletching(ArrowFletching value) {
            _fletching = value;
        }
        public void SetShaft(int value) {
            _shaft = value;
        }
